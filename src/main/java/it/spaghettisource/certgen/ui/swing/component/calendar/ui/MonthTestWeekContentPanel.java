...
public class MonthTestWeekContentPanel extends JPanel {
    
    private final MonthTestWeekLayoutManager layoutManager;
    private final WeekGrid grid;
    
    /**
     * Creates a new instance of {@link MonthTestWeekContentPanel}
     */
    public MonthTestWeekContentPanel(final MonthTestWeekLayoutManager owner) {
        super(true);
        setOpaque(false);
    ...
    private void addToolTipListner() {
        ...
        addMouseMotionListener(new MouseAdapter() {
            ...
            final JCalendar calendar = MonthTestWeekContentPanel.this.layoutManager.getOwner();
